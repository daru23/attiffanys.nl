    ...
    PB = {
        ...
        addStyles: function () {
            ...
            var styles = [
                ...
                '#promoText {position: absolute; top: 20%; left: 10%; display: block; color: white; font-size: 30px; text-shadow: 2px 2px grey;}',
        ...
        buildPromo: function () {
            ...
            this.promo = {
                ...
                text: PBlib.makeElement('div', {id: 'promoText'}, o.promotionText || "Promotion text here..."),
            ...
            if (!o.disableCloseButton) {
                this.promo.content.appendChild(this.promo.text);
            }
